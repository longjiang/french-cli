...
export default {
  ...
  methods: {
    async getTables() {
      ...
      let forms = await (await this.$openFrench).wordForms(this.word)
      for (let form of forms) {
        form.form = await (await this.$openFrench).accent(form.form)
        form.field = await (await this.$openFrench).stylize(form.field)
        form.table = await (await this.$openFrench).stylize(form.table)
      }
