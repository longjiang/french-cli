    ...
    <div class="container mt2 mb2">
      <div class="row">
        <div class="col-sm-12">
          <h4>Reader</h4>
          <p>
            Write or paste in some French text, and annotated text will show up
          ...
          <div class="mt-4 mb-5">
            <textarea
              ...
              cols="30"
              rows="5"
              placeholder="Enter your French text here. Markdown and HTML also supported."
              v-model="text"
            ></textarea>
          </div>
          <Loader class="mb-5" />
      ...
      <div class="row mt-5">
        <div class="col-sm-12">
          ...
          <ul>
            <li>
              Look for French music lyrics on 
              <a href="http://www.megalyrics.ru/lyric/kino/gruppa-krovi.htm">Megalyrics</a>.
            </li>
            <li>
              Read books from various French sources directly in our
