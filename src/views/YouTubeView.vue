    ...
    <div class="container mt-5 mb-5">
      ...
      <div class="row">
        ...
        <div class="col-sm-6" :key="'transcript-' + args">
          ...
          >
            <h6>
              Sorry, this YouTube video does not have French closed captions.
            </h6>
            <p>
              ...
              subtitle with the language <b>French</b> then the video has French
              subtitles.
            </p>
            <p>
              To look for videos with French subtitles, search with a French
              keyword, and click
