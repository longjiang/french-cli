...
import '@/assets/css/frenchzerotohero.css'
import Vue from 'vue'
import VTooltip from 'v-tooltip'
import BootstrapVue from 'bootstrap-vue'
import FrenchZeroToHero from './FrenchZeroToHero'
...
Vue.prototype.$openFrench = FreeDict.load()
...
if (location.hash === '#/test') {
  ...
  new Vue({
    router,
    store,
    render: h => h(FrenchZeroToHero)
  }).$mount('#frenchzerotohero')
}
